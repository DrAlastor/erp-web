-- ===================================================================
-- HU-05: Datos de demostracion del catalogo de articulos
-- Idempotente: se puede aplicar sobre una base que ya tiene categorias
-- (las de V4) sin duplicarlas.
-- ===================================================================

INSERT INTO categorias (nombre, descripcion, activo) VALUES
    ('Electrónica', 'Dispositivos y accesorios electrónicos', TRUE),
    ('Oficina', 'Útiles y equipamiento de oficina', TRUE),
