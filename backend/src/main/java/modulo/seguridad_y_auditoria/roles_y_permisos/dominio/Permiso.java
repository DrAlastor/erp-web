package modulo.seguridad_y_auditoria.roles_y_permisos.dominio;

import modulo.seguridad_y_auditoria.roles_y_permisos.catalogo.AccionErp;
import modulo.seguridad_y_auditoria.roles_y_permisos.catalogo.DefinicionPermiso;
 ...
 * {@link modulo.seguridad_y_auditoria.roles_y_permisos.catalogo.CatalogoPermisos}; esta entidad es el
 * reflejo de esa definición en la base de datos.
 */
@Entity(name = "RbacPermiso")
@Table(name = "permiso")
