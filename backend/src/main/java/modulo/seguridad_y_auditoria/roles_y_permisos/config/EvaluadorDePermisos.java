package modulo.seguridad_y_auditoria.roles_y_permisos.config;
...
public class EvaluadorDePermisos implements PermissionEvaluator {
    ...
    private UsuarioPrincipal principalDe(Authentication autenticacion) {
        ...
        return modulo.seguridad_y_auditoria.roles_y_permisos.auth.UsuarioActual.desde(autenticacion).orElse(null);
    }
