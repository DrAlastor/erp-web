...
public class ServicioAsignaciones {
    ...
    @Transactional(readOnly = true)
    public List<AsignacionDto> rolesDe(UUID empresaId, UUID usuarioId) {
    ...
    @Transactional
    public void asignar(UUID empresaId, UUID usuarioId, UUID rolId, UsuarioPrincipal actor) {
    ...
    @Transactional
    public void quitar(UUID empresaId, UUID usuarioId, UUID rolId, UsuarioPrincipal actor) {
        Usuario usuario = buscarUsuario(empresaId, usuarioId);
        Rol rol = buscarRol(empresaId, rolId);
    ...
    private Usuario buscarUsuario(UUID empresaId, UUID usuarioId) {
