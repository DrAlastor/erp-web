...
import com.uagrm.erp.backend.seguridad.web.dto.Peticiones;
import com.uagrm.erp.backend.seguridad.web.dto.UsuarioResumenDto;
...
public class ControladorAsignaciones {
    ...
    @PreAuthorize("hasPermission('SEGURIDAD','CONSULTAR')")
    public List<AsignacionDto> rolesDelUsuario(@PathVariable UUID usuarioId) {
    ...
    public void asignarRol(@PathVariable UUID usuarioId, @Valid @RequestBody Peticiones.Asignacion cuerpo) {
    ...
    public void quitarRol(@PathVariable UUID usuarioId, @PathVariable UUID rolId) {
        UsuarioPrincipal actor = UsuarioActual.obtener();
